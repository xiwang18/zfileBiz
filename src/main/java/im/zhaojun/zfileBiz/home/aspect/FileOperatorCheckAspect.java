package im.zhaojun.zfileBiz.home.aspect;
...
import im.zhaojun.zfileBiz.admin.model.enums.FileOperatorTypeEnum;
...
public class FileOperatorCheckAspect {
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * im.zhaojun.zfileBiz.home.service.base.AbstractBaseFileService.newFolder(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * im.zhaojun.zfileBiz.home.service.base.AbstractBaseFileService.delete*(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * im.zhaojun.zfileBiz.home.service.base.AbstractBaseFileService.getUploadUrl(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * im.zhaojun.zfileBiz.home.service.base.AbstractBaseFileService.rename*(..))")
	 ...
	 * @return  方法运行结果
	 */
	@Around("execution(public * im.zhaojun.zfileBiz.home.service.base.AbstractBaseFileService.search(..))")
