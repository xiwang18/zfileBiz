...
import im.zhaojun.zfileBiz.admin.annoation.RefererCheck;
import im.zhaojun.zfileBiz.admin.model.enums.RefererTypeEnum;
...
public class RefererCheckAspect {
	 ...
	 * @return  方法运行结果
	 */
	@Around(value = "@annotation(im.zhaojun.zfileBiz.admin.annoation.RefererCheck)")
